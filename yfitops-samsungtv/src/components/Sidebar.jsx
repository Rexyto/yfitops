...
const styles = {
  sidebar: {
    width: 300, background: 'var(--bg1)', borderRight: '1px solid var(--border)',
    display: 'flex', flexDirection: 'column', padding: '0 0 24px 0',
    flexShrink: 0, paddingTop: 40,
  },
  logo: { display: 'flex', alignItems: 'center', gap: 14, padding: '24px 26px 32px 26px' },
  logoImg: { width: 44, height: 44, borderRadius: 10, objectFit: 'cover' },
  logoText: { fontSize: 26, fontWeight: 800, color: 'var(--text)', letterSpacing: -0.5 },
  nav: { display: 'flex', flexDirection: 'column', gap: 6, padding: '0 16px' },
  navItem: {
  ...
  navIcon: { fontSize: 21, width: 26, textAlign: 'center' },
  activeDot: {
    position: 'absolute', left: 0, top: '50%', transform: 'translateY(-50%)',
    width: 4, height: 26, background: '#1ed760', borderRadius: 2,
  },
  bottom: { marginTop: 'auto', padding: '0 18px', display: 'flex', flexDirection: 'column', gap: 14 },
  offline: {
    display: 'flex', alignItems: 'center', gap: 10,
    background: '#ff555515', border: '1px solid #ff555540',
    borderRadius: 10, padding: '12px 16px',
  },
  offlineText: { color: '#ff8080', fontSize: 15, fontWeight: 700 },
  listeners: {
    display: 'flex', alignItems: 'center', gap: 10,
    background: '#1ed76015', border: '1px solid #1ed76030',
    borderRadius: 10, padding: '12px 16px',
  },
  listenersText: { color: '#1ed760', fontSize: 15, fontWeight: 700 },
  userRow: {
    display: 'flex', alignItems: 'center', gap: 14,
    background: 'var(--bg3)', borderRadius: 12, padding: '13px 16px',
  },
  avatar: {
    width: 40, height: 40, borderRadius: '50%',
    background: '#1ed76033', border: '1px solid #1ed76055',
    display: 'flex', alignItems: 'center', justifyContent: 'center',
    color: '#1ed760', fontWeight: 800, fontSize: 17, flexShrink: 0,
  },
  avatarImg: {
    width: 40, height: 40, borderRadius: '50%', objectFit: 'cover',
    border: '1px solid #1ed76055', flexShrink: 0,
  },
  userName: { flex: 1, color: 'var(--text-secondary)', fontSize: 16, fontWeight: 600, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' },
  logoutBtn: { background: 'none', border: 'none', cursor: 'pointer', color: 'var(--text-dim)', fontSize: 24, padding: 0, flexShrink: 0, lineHeight: 1 },
};

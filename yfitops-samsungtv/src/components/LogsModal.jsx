...
const styles = {
  ...
  modal: {
    width: 1160, maxWidth: '92vw', height: '78vh',
    background: 'var(--bg2)', border: '1px solid var(--border)', borderRadius: 24,
    display: 'flex', flexDirection: 'column', padding: 34,
  },
  ...
  sub: { color: 'var(--text-dim)', fontSize: 13, fontWeight: 700, textTransform: 'uppercase', letterSpacing: 1 },
  closeBtn: {
    background: 'var(--bg3)', border: 'none', borderRadius: '50%',
    width: 44, height: 44, color: 'var(--text-muted)', fontSize: 19, cursor: 'pointer', flexShrink: 0,
  },
  clearBtn: {
    alignSelf: 'flex-start', marginBottom: 16,
    background: 'none', border: '1px solid var(--border-strong)', borderRadius: 10,
    padding: '10px 20px', color: 'var(--text-muted)', fontSize: 15, fontWeight: 700, cursor: 'pointer',
  },
  list: {
  ...
  entry: {
    ...
    borderBottom: '1px solid var(--border)', fontSize: 15, alignItems: 'baseline',
    fontFamily: 'monospace',
  },
  level: { fontWeight: 800, width: 64, flexShrink: 0 },
  time: { color: 'var(--text-faint)', width: 82, flexShrink: 0 },
  text: { color: 'var(--text-secondary)', wordBreak: 'break-word' },
  empty: { color: 'var(--text-dim)', textAlign: 'center', marginTop: 70, fontSize: 17 },
};

...
const styles = {
  ...
  card: { width: 440, background: 'var(--bg2)', borderRadius: 24, padding: '48px 44px', border: '1px solid var(--border)' },
  logoWrap: { display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: 40 },
  logoCircle: { width: 104, height: 104, borderRadius: '50%', overflow: 'hidden', border: '2px solid #1ed76055', marginBottom: 16 },
  logoImg: { width: '100%', height: '100%', objectFit: 'cover' },
  appName: { fontSize: 34, fontWeight: 800, color: 'var(--text)', letterSpacing: -1 },
  hint: { marginTop: 10, fontSize: 13, color: 'var(--text-dim)', fontWeight: 600, textAlign: 'center' },
  form: { display: 'flex', flexDirection: 'column', gap: 16 },
  inputWrap: { display: 'flex', alignItems: 'center', background: 'var(--bg3)', borderRadius: 12, border: '1px solid var(--border-strong)', padding: '0 18px' },
  inputIcon: { fontSize: 19, marginRight: 12, flexShrink: 0 },
  input: { flex: 1, background: 'none', border: 'none', outline: 'none', color: 'var(--text)', fontSize: 18, padding: '18px 0' },
  showPassRow: {
    display: 'flex', alignItems: 'center', gap: 10,
    background: 'none', border: '1px dashed var(--border-strong)', borderRadius: 10,
    padding: '10px 16px', color: 'var(--text-muted)', fontSize: 14, fontWeight: 600,
    cursor: 'pointer', alignSelf: 'flex-start',
  },
  showPassIcon: { fontSize: 16 },
  error: { color: '#ff5555', fontSize: 14, textAlign: 'center' },
  loginBtn: { background: '#1ed760', border: 'none', borderRadius: 12, padding: '18px 0', color: '#000', fontWeight: 800, fontSize: 18, cursor: 'pointer', marginTop: 8 },
};

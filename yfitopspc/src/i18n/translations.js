...
const es = {
  ...
  // Perfil (sección propia)
  'profile.title': 'Perfil',
  'profile.subtitle': 'Tu cuenta, tus estadísticas y tus logros',
  'profile.picture.subtitle': 'Tu foto se guarda solo en este dispositivo, nunca se sube al servidor',
  'profile.picture.upload': 'Subir foto',
  'profile.picture.uploading': 'Subiendo...',
  'profile.picture.change': 'Cambiar foto',
  'profile.picture.remove': 'Quitar foto',
  ...
  'profile.stats.totalTime': 'Tiempo total',
...
const en = {
  ...
  'profile.subtitle': 'Your account, stats, and achievements',
  'profile.picture.subtitle': 'Your photo is stored only on this device, never uploaded to the server',
  'profile.picture.upload': 'Upload photo',
  'profile.picture.uploading': 'Uploading...',
  'profile.picture.change': 'Change photo',
